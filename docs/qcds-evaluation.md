...
| Satisfaction | A- | Japanese UI, single-button settings toggle, thumbnail-only queue, main import/edit/export flow, desktop layout, and mobile layout were verified. |
...
- `npm run test:e2e`: 2 passed
  - Desktop Chrome project: Japanese default UI, internal language switch API, multi-image import, thumbnail-only queue, internal queue scroll, visible canvas, settings toggle, draw brush mosaic, persist suffix, export ZIP.
...
- Screenshot checks:
  - Desktop settings open: `E:\DevEnv\Temp\User\image-mosaic-effect-qa\desktop-open.png`
  - Desktop settings hidden: `E:\DevEnv\Temp\User\image-mosaic-effect-qa\desktop-settings-hidden.png`
  - Mobile settings open: `E:\DevEnv\Temp\User\image-mosaic-effect-qa\mobile-open.png`
